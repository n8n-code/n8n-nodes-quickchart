...
![quickchart Banner](banner.svg)

[![npm version](https://img.shields.io/npm/v/@n8n-dev/n8n-nodes-quickchart.svg)](https://www.npmjs.com/package/@n8n-dev/n8n-nodes-quickchart)
...
```bash
npm install @n8n-dev/n8n-nodes-quickchart
```

**Or in n8n:**
1. **Settings → Community Nodes → Install**
2. Search: `@n8n-dev/n8n-nodes-quickchart`
3. Click **Install**
...
2. Add credentials: **quickchart API** → paste your API key
3. Drag the **quickchart** node into your workflow
...
## Auto-Generated
This node was auto-generated from the official **quickchart** OpenAPI specification using
